...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Courses) {
            ...
            startActivity(i);
        } else if (id == R.id.nav_Todays_plan) {
            Intent i = new Intent(getApplicationContext(), TodaysPlan.class);
            startActivity(i);
        } else if (id == R.id.nav_Discussion_groups) {
            Intent i = new Intent(getApplicationContext(), DiscussionGroups.class);
            startActivity(i);
